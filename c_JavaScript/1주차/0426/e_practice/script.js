...
// !숫자 입력 받기
while (true){
  const userInput = prompt('1부터 100사의 정수를 입력하세요.');
  const guess = parseInt(userInput); // !정수로 전환
  if (!guess || guess <1 || guess >100) {
    console.log('유효한 숫자를 입력해 주세요.');
    continue;
  }
  if (guess < targetNumber) {
    console.log('더 높은 숫자를 입력해 주세요');
  } else if (guess > targetNumber) {
    console.log('더 낮은 숫자를 입력해 주세요');
  } else{
    console.log('정답, 종료합니다.');
    break;
  }
}